import { HistoryItem, Notification, Settings, Tool } from "@/types";
...
export const useSetCurrentTool = () =>
  useAppStore((state) => state.setCurrentTool);
...
export const useRemoveFromHistory = () =>
  useAppStore((state) => state.removeFromHistory);
