...
sed -i "s/COMPONENT_NAME_LOWER/${COMPONENT_NAME,,}/g" "$COMPONENT_DIR/$COMPONENT_NAME.tsx"
...
# 替换占位符
sed -i "s/COMPONENT_NAME/$COMPONENT_NAME/g" "$COMPONENT_DIR/$COMPONENT_NAME.stories.tsx"
