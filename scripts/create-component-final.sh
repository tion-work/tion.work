...
# 替换占位符
perl -pi -e "s/COMPONENT_NAME/$COMPONENT_NAME/g" "$COMPONENT_DIR/$COMPONENT_NAME.tsx"
perl -pi -e "s/COMPONENT_NAME_LOWER/${COMPONENT_NAME,,}/g" "$COMPONENT_DIR/$COMPONENT_NAME.tsx"
...
# 替换占位符
perl -pi -e "s/COMPONENT_NAME/$COMPONENT_NAME/g" "$COMPONENT_DIR/$COMPONENT_NAME.test.tsx"
...
# 替换占位符
perl -pi -e "s/COMPONENT_NAME/$COMPONENT_NAME/g" "$COMPONENT_DIR/$COMPONENT_NAME.stories.tsx"
...
# 替换占位符
perl -pi -e "s/COMPONENT_NAME/$COMPONENT_NAME/g" "$COMPONENT_DIR/index.ts"
